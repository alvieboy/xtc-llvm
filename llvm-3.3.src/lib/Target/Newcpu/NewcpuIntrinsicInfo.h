//===-- NewcpuIntrinsicInfo.h - Newcpu Intrinsic Information ----*- C++ -*-===//
//
...
//
//===----------------------------------------------------------------------===//
#ifndef NEWCPUINTRINSICS_H
#define NEWCPUINTRINSICS_H

#include "llvm/Target/TargetIntrinsicInfo.h"

namespace llvm {

  class NewcpuIntrinsicInfo : public TargetIntrinsicInfo {
  public:
